			...
			<fieldset>
				...
				<div>
					...
					<label class="input-control checkbox">
						<input type="checkbox" id="activo" name="activo" <?php if($rowsC[0]['ACTIVO']==1){ ?> checked <?php } ?> />
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="nombre" name="nombre" maxlength="255" placeholder="Introducir el nombre" value="<?php echo $rowsC[0]['NOMBRE']; ?>" />
					</div>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="direccion" name="direccion" maxlength="100" placeholder="Introducir la direccion" value="<?php echo $rowsC[0]['DIRECCION']; ?>" />
					</div>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input style="width: 100%" type="text" id="localidad" name="localidad" maxlength="100" placeholder="Introducir la localidad" value="<?php echo $rowsC[0]['LOCALIDAD']; ?>" />
					</div>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="cp" name="cp" maxlength="5" placeholder="Introducir el codigo postal" value="<?php echo $rowsC[0]['CP']; ?>" />
					</div>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="telefono" name="telefono" maxlength="20" placeholder="Introducir el telefono" value="<?php echo $rowsC[0]['TELEFONO']; ?>" />
					</div>
				</div>
				<div style="width: 100%">
					<span class="etiquetas">Fax</span>
					<div class="input-control modern text campos">
						<input type="text" id="fax" name="fax" maxlength="20" placeholder="Introducir el fax" value="<?php echo $rowsC[0]['FAX']; ?>" />
					</div>	
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="contacto_cli" name="contacto_cli" maxlength="100" placeholder="Introducir el contacto" value="<?php echo $rowsC[0]['CONTACTO']; ?>" />
					</div>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="input-control modern text campos">
						<input type="text" id="email" name="email"  maxlength="20" placeholder="Introducir el email con el formato: alguien@dominio.com" value="<?php echo $rowsC[0]['EMAIL']; ?>" />
					</div>
				</div>
				
				<div style="width: 100%">
					<span class="etiquetas observaciones">Observaciones</span>
					<div class="input-control modern textarea campos">
						<textarea name="observaciones" id="observaciones"><?php echo $rowsC[0]['OBSERVACIONES']; ?></textarea>
					</div>
				</div>
				
				
				<div>
					<input type="button" name="btnActualizar" id="btnActualizar" value="Actualizar" class="enviar red"  />
				</div>
				<div></div>
...
<!-- Mostramos los trabajos del cliente en cuestion-->
	...
	<input type="button" name="btnNuevoTrabajo" id="btnNuevoTrabajo" value="Nuevo trabajo" class="enviar"  />
	...
	<?php
		...
		?>
			...
			<table id='trabajosClientes' name='trabajosClientes' class='table striped hovered border bordered'>
				<thead>
				...
				<fieldset>
					<legend>Nuevo trabajo</legend>
						...
						<div style="width: 100%">
							<span class="etiquetas">Nombre</span>
								<div class="input-control modern textarea campos">
									<input type="text" id="nombreTrabajo" maxlength="255" placeholder="Introducir el nombre del trabajo" name="nombreTrabajo" value="" />
							</div>
						</div>
						<div style="width: 100%">
							<span class="etiquetas">Proveedor</span>
							<div class="input-control modern textarea campos">
								<select id="proveedorTrabajo" name="proveedorTrabajo"></select>
							</div>
						</div>
						<div style="width: 100%">
						...
						<div style="width: 100%">
							...
							<div class="input-control modern textarea campos" data-role="datepicker">
								<input type="text" id="fechaTrabajo" name="fechaTrabajo" maxlength="100" placeholder="Introducir la fecha con formato dd/mm/aaaa" value=""  />
							</div>
						</div>
						<div style="width: 100%">
							<span class="etiquetas">Precio</span>
							<div class="input-control modern textarea campos">
								<input type="text" id="precioTrabajo" name="precioTrabajo" maxlength="5" placeholder="Introducir el precio del trabajo" value="" />
							</div>
						</div>
						<div style="width: 100%">
							<span class="etiquetas">Descripcion</span>
							<div class="input-control modern textarea campos">
								<textarea name="descripcionTrabajo" id="descripcionTrabajo"></textarea>
							</div>
						</div>
						
						<input type="button" name="btnCerrar" id="btnCerrar" value="Cerrar" class="enviar" />
						<input type="button" name="btnGuardarTrabajo" id="btnGuardarTrabajo" value="Guardar" class="enviar" />
				</fieldset>
			</form>
</div>
