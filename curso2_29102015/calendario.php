<?php
    ...
    $year=date('Y');
    if(isset($_POST['time_anos'])){
        $year = $_POST['time_anos'];
    }else{
        $year = date('Y');
    }
    
    $meses=array(1=>"Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
    $html = "<form method='post' action='calendario.php'>";
    $html .= "<select name='meses'>";
    ...
    $html .= "</select>";
    $html .="<input type='number' name=time_anos value='".$year."' min='1975' max='2100' />";
