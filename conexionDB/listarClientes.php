<?php
	...
	foreach ($rows as $rowF) {
		...
		$tabla .= "<td class='trabajo'>".$rowF["PUNTUACION_TRABAJO"]."</td>";
		$tabla .= "<td class='activo'>".activo($rowF["ACTIVO"])."</td>";
		$tabla .= "<td class='editar'><a class'editar' href='ficha_nueva_clientes.php?nif=".$rowF["NIF"]."&opciones=editar'><img src='images/doc.png' alt='Editar el contacto'  style='width:32px;height:32px;' /></a></td>";
