<?php
    ...
    if(isset($_POST['id'])){
        $query = "UPDATE proveedor SET activo = 0 WHERE id=:id";
        $db = new Conexion();
        ...
        if ($db->ejecutarInsertUpdateDelete($sentencia)){
            echo "El proveedor seleccionado se ha dado de baja correctamente";
...
<html>
    <head>
        ...
        <title>Borrado de proveedores</title>
    </head>
    <body>
       <div class="well bs-component" style="width: 70%; margin: 0 auto;">
           <form action="" method="post">
               <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" />
               <span>¿Desea borrar el proveedor seleccionado?</span>
               <input type="submit" class="btn btn-danger" value="Borrar" />
               <a href="ver_proveedores.php" class="btn btn-success">Cancelar</a>
           </form>
       </div>
    </body>
</html>